      ...
      return {
        ...
        table: {
          ...
          body: [
            // head
            [
              { text: 'ID', rowSpan: 3, margin: [0, 20, 0, 0] },
              ...
              // Subjects
              {
                ...
                alignment: "center",
                stack: [
                  { text: 'Course Code: ICT-701', bold: true },
                  { text: 'C.H.3', bold: true },
                  { text: 'Title: Wireless and Mobile Communication', bold: true },
                ]
              },
              {},
              {},
            ...
            [
              ...
              // Each Subject
              { text: 'Before Exam', rowSpan: 2 },
              { text: 'Final Exam', rowSpan: 2 },
              { text: 'Total Marks', rowSpan: 2 },
              { text: 'LG', rowSpan: 2 },
              { text: 'GP', rowSpan: 2 },
                  ...
                  [
                    {
                      stack: [
                        ...
                        { text: '01. Name__', alignment: "left", },
                        { text: '02. Name__', alignment: "left", },
                      ]
                    }
                  ],
                ]
